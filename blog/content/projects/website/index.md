...
Using Github Actions, when changes are made, the blog will automatically be rebuilt and the new build will be pushed to a local SeaweedFS S3 bucket, using self hosted runner on Kubernetes ARC.
